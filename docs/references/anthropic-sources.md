...
| S7 | https://claude.com/blog/building-agents-with-the-claude-agent-sdk | 2025-09-29 | Loop **gather context → take action → verify work → repeat**; verify = rules-based / visual / LLM-as-judge | 3.2, 7.2, 8.4, 9.3, 14.3 |

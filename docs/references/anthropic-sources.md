...
| S15 | https://code.claude.com/docs/en/costs, https://code.claude.com/docs/en/sub-agents, https://code.claude.com/docs/en/agent-teams, https://code.claude.com/docs/en/workflows, https://code.claude.com/docs/en/checkpointing, https://code.claude.com/docs/en/security | living | Cost ladder; khi nào subagent / team / workflow; team ≈ 7× token; checkpoint không track Bash | 3.2, 4.2, 5.2, 7.2, 7.5, 8.2, 8.5, 10.1, 11.5, 14.4, 15.1 |

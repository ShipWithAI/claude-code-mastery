...
trong shell của bạn. `--permission-mode default` ép về hành vi gốc; trên gói Pro, Max và Team,
starting mode built-in là `auto`, và `permissions.defaultMode` ghi đè nó.
